...
\subsubsection*{CAS}
La CAS a déjà annoncé qu’elle reconnaîtrait le nouveau format des examens FM/2 et MFE/3F (IMF) à partir de l’été 2017. 

\textbf{Voici les éléments clés de l’annonce de juin :}
\begin{itemize}
\item Modification de l'examen S (MAS-1) 
\item Modification de l'examen C (MAS-2 pour la CAS et STAM pour la SOA)
\end{itemize}
\vspace{\baselineskip} 
